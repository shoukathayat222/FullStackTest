  	...
  	<div class="container py-5">
		<div class="contacts12-main py-md-3">
			...
			<div class="header-section text-center">
				<h3 class="mb-md-5 mb-4">Signup Here
			</div>
			<form action="{{ url('/register') }}" method="post" class="">
				...
				<div class="main-input">
					...
					<input type="password" name="confirm_password" placeholder="Retype Password" class="contact-input" required="" />	
				</div>
				<div class="text-right" style="text-align: center !important;">
					<button class="btn-primary btn theme-button" type="submit">Signup</button>
				</div>
			</form>
		</div>
	</div>
